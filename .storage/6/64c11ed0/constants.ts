...
export const RECOMMENDATIONS_DB: Recommendation[] = [
  {
    ...
    description: 'Replace 30% of car trips with bus or train to reduce emissions by ~25kg CO₂/month',
  ...
  },
  {
    ...
    description: 'Use bicycle for trips under 5km to cut emissions by ~15kg CO₂/month',
  ...
  },
  {
    ...
    description: 'Install programmable thermostat to reduce heating/cooling by ~20kg CO₂/month',
  ...
  },
  {
    ...
    description: 'Replace 2 business flights per year with video calls to save ~180kg CO₂/year',
  ...
  },
  {
    ...
    description: 'Go vegetarian one day per week to reduce emissions by ~10kg CO₂/month',
  ...
  },
  {
    ...
    description: 'Replace 50% of meat meals with plant proteins to save ~30kg CO₂/month',
  ...
  },
  {
    ...
    description: 'Start home composting to reduce waste by 40% and save ~16kg CO₂/month',
