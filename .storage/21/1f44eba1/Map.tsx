...
export default function Map() {
  ...
  const communityData = MOCK_COMMUNITY_DATA.map(user => ({
    ...user,
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="map-header mb-8">
          ...
          <p className="text-gray-600">
            Explore carbon emissions in your area and see how you compare with neighbors
          </p>
        </div>
            ...
            <Card className="map-container">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  San Francisco Bay Area - Carbon Heatmap
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div 
            ...
            <Card className="community-card">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Lowest Emitter</span>
                    <Badge className="bg-green-100 text-green-800">
                      {Math.min(...communityData.map(u => u.total_co2)).toFixed(1)} kg
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Highest Emitter</span>
                    <Badge className="bg-red-100 text-red-800">
                      {Math.max(...communityData.map(u => u.total_co2)).toFixed(1)} kg
                    </Badge>
                  </div>
                </div>
              </CardContent>
